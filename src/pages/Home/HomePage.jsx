...
import ArrowBlink from "../../components/Arrow";
            ...
            <div className={`slide py-24 ${darkMode ? 'bg-primary-dark color-quaternary-dark' : 'bg-primary-light color-quaternary-light'}`} id="home">
                <div className="wrapper flex flex-col gap-10">
                    <div className="flex flex-col gap-5">
                        {/*Jumbotron home */}
                        <div className="home_jumbotron max-lg:w-full lg:w-[55%] flex-wrap flex gap-5">
                            <h1 className="home_jumbotron_high display-lg max-md:text-4xl nohemi flex w-full flex-wrap items-center gap-4">
                                Dylan Quenon,
                                <img src="images/home1.webp" className="w-[120px] h-11 rounded-full object-cover" alt="Web developer at work" /> {t('home.title')}
                                {/* Typewritter */}
                                <div className={`typewritter relative flex max-lg:flex-col gap-2 display-lg basis-full ${darkMode ? "color-secondary-dark" : 'color-secondary-light'} nohemi bold`}>
                                    <TypewriterComponent
                                        options={{
                                    ...
                                    />
                                    {/*2e picture */}
                                    <img src="images/home2.webp" className="w-[120px] h-11 lg:absolute top-50 right-32 rounded-full object-cover" alt="Web developer at work" />
                                </div>
                            </h1>
                        </div>
                        {/*Boutons d'actions */}
                    ...
                    {/*Link*/}
                    <div className="grid sm:grid-cols-1 gap-x-9 max-lg:gap-y-9 lg:grid-cols-12 gap-5 w-full">
                        {/*Link 1*/}
                        <div className="home_link col-span-4 relative">
                            <NavLink
                                to="/"
                                className="border-2 overflow-hidden border-[#f5f5f5] py-5 px-4 display-xl hanken uppercase color-primary-light flex items-end home_link_block max-lg:h-[300px] h-[500px] relative rounded-3xl bg-center bg-no-repeat bg-cover group"
                            ...
                            <div className="arrows w-16 h-16 rounded-full bg-[rgba(1,33,105,0.7)] flex justify-center items-center absolute max-md:-top-[5%] max-md:-right-[1%] -top-6 -right-5 border-[#012169] border-2"> <ArrowOutwardIcon fontSize="large" htmlColor="#f5f5f5" /> </div>
                        </div>
                        {/* Bloc 2 */}
                        <div className="home_link col-span-3 max-lg:col-span-4 flex lg:flex-row xl:flex-col max-md:flex-col max-md:gap-9 md:gap-5 xl:gap-0 relative ">                            <div className="relative w-full ">
                                ...
                                <div className="arrows w-16 h-16 rounded-full bg-[rgba(1,33,105,0.7)] flex justify-center items-center absolute max-md:-top-[5%] max-md:-right-[2%] -top-10 -right-5 border-[#012169] border-2"> <ArrowOutwardIcon fontSize="large" htmlColor="#f5f5f5" /> </div>

                            </div>

                            <div className={`home_link_block h-[250px] max-lg:w-1/2" relative w-full ${darkMode ? "bg-tertiary-dark color-quaternary-dark" : "bg-tertiary-light color-quaternary-light"} flex justify-center items-center rounded-3xl`}>
                    ...
                    <div className="home-about py-24 app_container flex gap-5 flex-col w-full items-center">
                        <div className="flex justify-center relative z-10 max-md:translate-x-7">
                        ...
                        <h3 className=" relative max-md:flex max-md:flex-col items-center display-md other inline nohemi max-lg:block w-4/5 text-center font-[400]">
                            <span className="z-10 relative">{t('home.aboutTitle')}</span>  <span className={`relative z-10 display-md nohemi bold  py-2 px-3 rounded-full border-2 inline w-fit gap-2 ${darkMode ? 'border-[#9D78F4] color-secondary-dark' : 'border-[#341087]  color-secondary-light'}`}> <BrushIcon fontSize="large" /> {t('home.design')}</span>  <span className="z-10 relative"> {t('home.and')}</span> <br />   <span className={` relative z-10   leading-snug display-md nohemi max-md:flex flex-wrap items-center justify-center bold py-2 px-3 rounded-full border-2 inline w-fit gap-2 ${darkMode ? 'border-[#9D78F4] color-secondary-dark' : 'border-[#341087]  color-secondary-light'}`}> <DevicesIcon fontSize="large" /> <span className="max-md:w-full">{t('home.solutions')}</span> </span>
